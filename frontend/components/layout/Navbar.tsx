...
export function Navbar() {
  ...
  const { isConnected, isDemo, tryDemo, address, totalPortfolioINR } = useWallet();
  ...
  return (
    <>
      ...
      <motion.nav
        className={`fixed left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#0A0A0F]/80 backdrop-blur-xl border-b border-white/[0.06] transition-all duration-300 ${isDemo ? 'top-6' : 'top-0'}`}
